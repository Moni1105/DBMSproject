...
app.config['MYSQL_PASSWORD'] = '$aiBaba1105'
...
def register(): 
	msg = '' 
	if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form and 'phoneno' in request.form  and 'address' in request.form and 'city' in request.form and 'state' in request.form and 'country' in request.form and 'usertype' in request.form: 
		username = request.form['username']
		password = request.form['password']
